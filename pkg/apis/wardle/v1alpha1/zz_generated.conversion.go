...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Customer)(nil), (*wardle.Customer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Customer_To_wardle_Customer(a.(*Customer), b.(*wardle.Customer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.Customer)(nil), (*Customer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_Customer_To_v1alpha1_Customer(a.(*wardle.Customer), b.(*Customer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomerAddress)(nil), (*wardle.CustomerAddress)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CustomerAddress_To_wardle_CustomerAddress(a.(*CustomerAddress), b.(*wardle.CustomerAddress), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.CustomerAddress)(nil), (*CustomerAddress)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_CustomerAddress_To_v1alpha1_CustomerAddress(a.(*wardle.CustomerAddress), b.(*CustomerAddress), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomerList)(nil), (*wardle.CustomerList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CustomerList_To_wardle_CustomerList(a.(*CustomerList), b.(*wardle.CustomerList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.CustomerList)(nil), (*CustomerList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_CustomerList_To_v1alpha1_CustomerList(a.(*wardle.CustomerList), b.(*CustomerList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomerSpec)(nil), (*wardle.CustomerSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CustomerSpec_To_wardle_CustomerSpec(a.(*CustomerSpec), b.(*wardle.CustomerSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.CustomerSpec)(nil), (*CustomerSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_CustomerSpec_To_v1alpha1_CustomerSpec(a.(*wardle.CustomerSpec), b.(*CustomerSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*CustomerStatus)(nil), (*wardle.CustomerStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CustomerStatus_To_wardle_CustomerStatus(a.(*CustomerStatus), b.(*wardle.CustomerStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*wardle.CustomerStatus)(nil), (*CustomerStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_wardle_CustomerStatus_To_v1alpha1_CustomerStatus(a.(*wardle.CustomerStatus), b.(*CustomerStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Customer_To_wardle_Customer(in *Customer, out *wardle.Customer, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_CustomerSpec_To_wardle_CustomerSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_CustomerStatus_To_wardle_CustomerStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_Customer_To_wardle_Customer is an autogenerated conversion function.
func Convert_v1alpha1_Customer_To_wardle_Customer(in *Customer, out *wardle.Customer, s conversion.Scope) error {
	return autoConvert_v1alpha1_Customer_To_wardle_Customer(in, out, s)
}

func autoConvert_wardle_Customer_To_v1alpha1_Customer(in *wardle.Customer, out *Customer, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_wardle_CustomerSpec_To_v1alpha1_CustomerSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_wardle_CustomerStatus_To_v1alpha1_CustomerStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_wardle_Customer_To_v1alpha1_Customer is an autogenerated conversion function.
func Convert_wardle_Customer_To_v1alpha1_Customer(in *wardle.Customer, out *Customer, s conversion.Scope) error {
	return autoConvert_wardle_Customer_To_v1alpha1_Customer(in, out, s)
}

func autoConvert_v1alpha1_CustomerAddress_To_wardle_CustomerAddress(in *CustomerAddress, out *wardle.CustomerAddress, s conversion.Scope) error {
	// WARNING: in.AddressType requires manual conversion: does not exist in peer-type
	// WARNING: in.City requires manual conversion: does not exist in peer-type
	// WARNING: in.Postalcode requires manual conversion: does not exist in peer-type
	// WARNING: in.Street requires manual conversion: does not exist in peer-type
	return nil
}

func autoConvert_wardle_CustomerAddress_To_v1alpha1_CustomerAddress(in *wardle.CustomerAddress, out *CustomerAddress, s conversion.Scope) error {
	// WARNING: in.addressType requires manual conversion: does not exist in peer-type
	// WARNING: in.city requires manual conversion: does not exist in peer-type
	// WARNING: in.postalcode requires manual conversion: does not exist in peer-type
	// WARNING: in.street requires manual conversion: does not exist in peer-type
...
func autoConvert_v1alpha1_CustomerList_To_wardle_CustomerList(in *CustomerList, out *wardle.CustomerList, s conversion.Scope) error {
	// WARNING: in.ObjectMeta requires manual conversion: does not exist in peer-type
	out.Items = *(*[]wardle.Customer)(unsafe.Pointer(&in.Items))
	return nil
}

func autoConvert_wardle_CustomerList_To_v1alpha1_CustomerList(in *wardle.CustomerList, out *CustomerList, s conversion.Scope) error {
	// WARNING: in.ListMeta requires manual conversion: does not exist in peer-type
	out.Items = *(*[]Customer)(unsafe.Pointer(&in.Items))
	return nil
}

func autoConvert_v1alpha1_CustomerSpec_To_wardle_CustomerSpec(in *CustomerSpec, out *wardle.CustomerSpec, s conversion.Scope) error {
	// WARNING: in.Firstname requires manual conversion: does not exist in peer-type
	// WARNING: in.Lastname requires manual conversion: does not exist in peer-type
	// WARNING: in.Email requires manual conversion: does not exist in peer-type
	// WARNING: in.Addresses requires manual conversion: does not exist in peer-type
	return nil
}

func autoConvert_wardle_CustomerSpec_To_v1alpha1_CustomerSpec(in *wardle.CustomerSpec, out *CustomerSpec, s conversion.Scope) error {
	// WARNING: in.firstname requires manual conversion: does not exist in peer-type
	// WARNING: in.lastname requires manual conversion: does not exist in peer-type
	// WARNING: in.email requires manual conversion: does not exist in peer-type
	// WARNING: in.addresses requires manual conversion: does not exist in peer-type
...
func autoConvert_v1alpha1_CustomerStatus_To_wardle_CustomerStatus(in *CustomerStatus, out *wardle.CustomerStatus, s conversion.Scope) error {
	// WARNING: in.VerificationStatusValues requires manual conversion: does not exist in peer-type
	return nil
}

func autoConvert_wardle_CustomerStatus_To_v1alpha1_CustomerStatus(in *wardle.CustomerStatus, out *CustomerStatus, s conversion.Scope) error {
	// WARNING: in.verificationStatusValues requires manual conversion: does not exist in peer-type
	return nil
}
